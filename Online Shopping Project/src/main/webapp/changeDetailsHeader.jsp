...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
    ...
    <div class="topnav sticky">
            ...
            <h2><a href="home.jsp"><i class='fa fa-arrow-left'>Back</i></a></h2>
             <h2><a href="home.jsp">Your Profile(<%out.println(email); %>) <i class='fa fa-user'></i></a></h2>
            <a href="changePassword.jsp">Change Password <i class='fa fa-key'></i></a>
            <a href="addChangeAddress.jsp">Add or change Address <i class='fa fa-address-book-o'></i></a>
