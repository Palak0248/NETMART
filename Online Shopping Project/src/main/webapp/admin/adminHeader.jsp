...
<script src='https://kit.fontawesome.com/a076d05399.js'></script>
   ...
   <%String  email=session.getAttribute("email").toString(); %>
            <center><h2>NETMART</h2></center>
            <a href="addNewProduct.jsp">Add New Product <i class='fa fa-plus-square'></i></a>
            <a href="allProductEditProduct.jsp">All Products & Edit Products <i class='fa fa-pencil'></i></a>
            ...
            <a href="deliveredOrders.jsp">Delivered Orders <i class='fa fa-location-arrow'></i></a>
